...
a bundled Shiny application for predictor-assisted digitization: a trained
ml-morph model proposes the 19 FISHMORPH landmarks from a few calibration
clicks per specimen, which are then reviewed, corrected and exported to
`CSV`/`tpsDig`. It requires a live interactive session (and an external
ml-morph resource directory holding the trained predictor and a
